(function() {
	...
	$.MS = {
		...
		CE:{
			 ...
			 * @param oArgs {*} Optional. Value to pass as second argument to callback.
			 */
		 ...
		 */
		extend:function (ClassSub, ClassSuper, oMixins/*, additional objects to mix in*/) {
			...
			ClassSub.prototype.super = function (fnParent, args, sFunction) {
				return fnParent.prototype[sFunction || 'constructor'].apply(this, args);
			};
		 ...
		 * @param aPosHaystack1 {array} Required. A point point in the search space.
